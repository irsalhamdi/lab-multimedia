...
class TrainingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')){
            ...
            if($request->file('imagePembicara')){
                ...
                return redirect()->route('admin.training')->with($notification);
    ...
    public function edit($id)
    {
        ...
        $categories = TrainingCategory::orderBy('name', 'ASC')->get();
        return view('admin.training.edit', compact('training', 'categories', 'trainer'));
    }
    ...
    public function show($id)
    {
        $training = Training::findOrFail($id);
        $trainer = Trainer::where('training_id', $id)->first();
        return view('admin.training.detail', compact('training', 'trainer'));
    }
    ...
    {   
        $training = Training::findOrFail($id);
        $material = LearningMaterial::where('training_id', $training->id)->first();
        return view('admin.training.learning-material', compact('training', 'material'));
    }

    public function uploadLearningMaterial(Request $request, $id)
    {
        $request->validate([
            'file' => 'mimes:pdf,zip|max:2048',
        ],[
            'file.mimes' => 'tipe file harus pdf atau zip',
    ...
    public function participants($id)
    {
        ...
        $training = Training::findOrFail($id);
        return view('admin.training.participant', compact('participants', 'training'));
    }
