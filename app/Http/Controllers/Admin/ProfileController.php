...
class ProfileController extends Controller
{
    public function vission()
    {
        ...
        return view('admin.profile-lab.vission', compact('profile'));
    }
    ...
    {
        $profile = Profile::find(1);
        return view('admin.profile-lab.mission', compact('profile'));
    }
    ...
    {
        $profile = Profile::find(1);
        return view('admin.profile-lab.goal', compact('profile'));
    }
