...
class AsistantTrainingController extends Controller
{
    public function index()
    {
        $trainings = Training::orderBy('date', 'DESC')->filter(request(['search']))->paginate(3)->withQueryString();
        return view('asistant.training.index', compact('trainings'));
    }

    public function create()
    {
        $categories = TrainingCategory::orderBy('name', 'ASC')->get();
        return view('asistant.training.add', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')){
            ...
            if($request->file('imagePembicara')){
                ...
                return redirect()->route('asistant.training')->with($notification);
    ...
    public function edit($id)
    {
        ...
        $categories = TrainingCategory::orderBy('name', 'ASC')->get();
        return view('asistant.training.edit', compact('training', 'categories', 'trainer'));
    }
    ...
    public function show($id)
    {
        $training = Training::findOrFail($id);
        $trainer = Trainer::where('training_id', $id)->first();
        return view('asistant.training.detail', compact('training', 'trainer'));
    }
    ...
    {   
        $training = Training::findOrFail($id);
        $material = LearningMaterial::where('training_id', $training->id)->first();
        return view('asistant.training.learning-material', compact('training', 'material'));
    }
    ...
    public function participants($id)
    {
        ...
        $training = Training::findOrFail($id);
        return view('asistant.training.participant', compact('participants', 'training'));
    }
