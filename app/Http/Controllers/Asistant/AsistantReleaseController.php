...
class AsistantReleaseController extends Controller
{
    public function index()
    {   
        $releases = Release::latest()->filter(request(['search']))->paginate(3)->withQueryString();
        return view('asistant.release.index', compact('releases'));
    }

    public function create()
    {
        $categories = ReleaseCategory::orderBy('name', 'ASC')->get();
        return view('asistant.release.add', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('file')){
            ...
            return redirect()->route('asistant.release')->with($notification);
    ...
    public function edit($id)
    {
        ...
        $categories = ReleaseCategory::orderBy('name', 'ASC')->get();
        return view('asistant.release.edit', compact('release', 'categories'));
    }
