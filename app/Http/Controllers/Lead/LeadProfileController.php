...
class LeadProfileController extends Controller
{
    public function vission()
    {
        ...
        return view('lead.profile-lab.vission', compact('profile'));
    }
    ...
    {
        $profile = Profile::find(1);
        return view('lead.profile-lab.mission', compact('profile'));
    }
    ...
    {
        $profile = Profile::find(1);
        return view('lead.profile-lab.goal', compact('profile'));
    }
