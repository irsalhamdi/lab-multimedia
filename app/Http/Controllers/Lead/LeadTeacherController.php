...
class LeadTeacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lead.dosen')->with($notification);
    }

    public function edit($id)
    {
        $dosen = Dosen::findOrFail($id);
        return view('lead.dosen.edit', compact('dosen'));
    }
