        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Daftar Dosen <code><a href="{{ route('admin.dosen.add') }}">Tambah</a></code>
                </p>
                <form action="{{ route('admin.dosen') }}">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($dosens as $dosen)
                                    <tr>
                                        <td class="py-1">
                                            <img src="{{ ($dosen->profile != null) ? asset($dosen->profile) : asset('frontend/img/user.png') }}" alt="">
                                        </td>
                                        <td class="py-1">
                                            {{$dosen->name }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.dosen.edit', $dosen->id) }}" type="button" class="btn btn-warning btn-circle btn-sm justify-content-between flex-nowrap">
                                                <i class="typcn typcn-edit"></i>
                                            </a>
                                            <a href="{{ route('admin.dosen.delete', $dosen->id) }}" type="button" class="btn btn-danger btn-circle btn-sm justify-content-between flex-nowrap">
