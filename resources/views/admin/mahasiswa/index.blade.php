    ...
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <p class="card-description">
                Daftar Mahasiswa <code><a href="{{ route('admin.mahasiswa.add') }}">Tambah</a></code>
            </p>
            <form action="{{ route('admin.mahasiswa') }}">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    <td class="py-1">
                                        <img src="{{ ($user->profile != null) ? asset($user->profile) : asset('frontend/img/user.png') }}" alt="">
                                    </td>
                                    <td class="py-1">
                                        {{$user->name }}
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.mahasiswa.edit', $user->id) }}" type="button" class="btn btn-warning btn-circle btn-sm justify-content-between flex-nowrap">
                                            <i class="typcn typcn-edit"></i>
                                        </a>
                                        <a href="{{ route('admin.mahasiswa.delete', $user->id) }}" type="button" class="btn btn-danger btn-circle btn-sm justify-content-between flex-nowrap">
