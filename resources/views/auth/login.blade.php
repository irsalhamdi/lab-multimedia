                        ...
                        <div class="admission_form">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="apply_btn">
                                            <p>Belum mempunyai akun ? <a href="{{ route('register') }}" class="text-white"> Daftar</a></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="apply_btn">
                                            <p>Lupa password ? <a href="{{ route('password.request') }}" class="text-white"> Klik disini !</a> </p>
                                        </div>
                                    </div>
