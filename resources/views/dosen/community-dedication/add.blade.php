...
@section('main')
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tambah Pengabdian Masyarakat</h4>
            ...
            <form method="POST" action="{{ route('dosen.community.dedication.store') }}" class="forms-sample" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Tempat</label>
                    <input type="text" name="place" value="{{ old('place') }}" class="form-control @error('place') is-invalid @enderror" placeholder="Tempat Pengabdian">
                    @error('place')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <label>Waktu</label>
                    <input type="datetime-local" name="date" value="{{ old('date') }}" class="form-control @error('date') is-invalid @enderror" placeholder="Waktu Pengabdian">
                    @error('date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
