...
@section('main')
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('asistant.gallery.update', $gallery->id) }}" class="forms-sample" enctype="multipart/form-data">
                @csrf
                ...
                <a href="{{ route('asistant.galleries') }}" class="btn btn-light">Cancel</a>
