            ...
            <div class="row justify-content-end">
                <div class="col-lg-7">
                    <div class="admission_form">
                        <h3>Pendaftaran Member Lab</h3>
                        <form method="POST" action="{{ route('mahasiswa.daftar.member.submit') }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p>Silahkan tulis, <span style="color: white">saya memahami dan akan mengikuti persyaratan member lab</span></p>
