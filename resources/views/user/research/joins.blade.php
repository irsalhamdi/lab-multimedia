                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h4 class="card-title mb-3">{{ Str::limit($participant->research->title, 40) }}</h4>
                            <a href="{{ route('mahasiswa.penelitian.join', $participant->research->id) }}" type="button" class="btn btn-sm btn-light">Detail</a>
                        </div>
                        <div class="row">
                            <div class="col-12">
