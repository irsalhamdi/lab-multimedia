...
@section('main')
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('mahasiswa.berita.store') }}" class="forms-sample" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="video" value="{{ old('video') }}" class="form-control @error('video') is-invalid @enderror" placeholder="Link Video Berita">
                    @error('video')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <a href="{{ route('mahasiswa.berita') }}" class="btn btn-light">Cancel</a>
