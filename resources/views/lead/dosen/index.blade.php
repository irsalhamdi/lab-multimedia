        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Daftar Dosen <code><a href="{{ route('lead.dosen.add') }}">Tambah</a></code>
                </p>
                            ...
                            <tbody>
                                @foreach ($dosens as $dosen)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('lead.dosen.edit', $dosen->id) }}" type="button" class="btn btn-warning btn-circle btn-sm justify-content-between flex-nowrap">
                                                <i class="typcn typcn-edit"></i>
                                            </a>
                                            <a href="{{ route('lead.dosen.delete', $dosen->id) }}" type="button" class="btn btn-danger btn-circle btn-sm justify-content-between flex-nowrap">
