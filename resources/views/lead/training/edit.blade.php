...
@section('main')
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('lead.training.update.image', $training->id) }}" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('lead.training.update.image.trainer', $training->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('lead.training.update.form', $training->id) }}" class="forms-sample" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label>Nama</label>
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('asistant.training.update.form.trainer', $training->id) }}">
                @csrf
                <div class="form-group">
