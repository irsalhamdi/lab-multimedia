                ...
                <div class="row justify-content-end">
                    <div class="col-lg-7">
                        <div class="admission_form">
                            ...
                            <form method="POST" action="{{ route('mahasiswa.daftar.penelitian.submit', $research->id) }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <p>Silahkan tulis, <span style="color: white">saya memahami dan akan mengikuti persyaratan penelitian</span></p>
                                        ...
                                        <p>Pastikan anda telah membaca peraturan dan persyaratan mengikuti penelitian.</p>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="apply_btn">
