...
<html lang="en">
    ...
    <body>
        ...
        <table width="100%">
                <tr>
                    <p style="text-align: justify; font-family: sans-serif;">
                        ...
                        alat-alat pada <b>Laboratorium Instrumen & Apk Nanoteknologi</b> di Fakultas Ilmu Komputer Universitas
        ...
        <table width="100%">
            <tr>
                <b style="float: right; font-family: sans-serif;">Abdillahi Romadhone</b><br>
